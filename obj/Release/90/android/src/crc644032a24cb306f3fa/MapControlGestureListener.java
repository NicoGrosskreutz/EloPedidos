...
public class MapControlGestureListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Mapsui.UI.Android.MapControlGestureListener, Mapsui.UI.Android", MapControlGestureListener.class, __md_methods);
	}


	public MapControlGestureListener ()
	{
		super ();
		if (getClass () == MapControlGestureListener.class)
			mono.android.TypeManager.Activate ("Mapsui.UI.Android.MapControlGestureListener, Mapsui.UI.Android", "", this, new java.lang.Object[] {  });
	}
