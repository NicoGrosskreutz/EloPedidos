...
{
	public class AdapterListaPedidos : BaseAdapter<Pedido>
	{
		private Activity context;
		private List<Pedido> list;

		public AdapterListaPedidos(Activity _context, List<Pedido> _list)
		{
			context = _context;
			list = _list;
		}
		...
		{
			var view = convertView ?? context.LayoutInflater.Inflate(Resource.Layout.adapter_lista_pedidos, parent, false);
